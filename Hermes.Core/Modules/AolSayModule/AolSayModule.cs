...
namespace Hermes.Core.Modules.AolSayModule
{
    public class AolSayModule : ModuleBase<SocketCommandContext>
    {
        private readonly List<string> _responses = new List<string>
        {
            ...
            "EYE WHISH I COULD LIFT HÆVY TINGS LYKE DOZE GUIZ ON TEEVHEE",
            ...
            "WHEN EYE GHO TO THE CLITGIFNUGGETPASTESHOPPINGSENTURS EYE UZE SHNUPPING CÆRTZ",
